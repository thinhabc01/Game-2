...
namespace SS.View
{
    public class Manager
    {
        ...
        public static Controller BellowController()
        {
            if (m_ControllerStack.Count > 0)
            {
                return m_ControllerStack.Pop();
            }

            return null;
        }

        public static void PushTopController(Controller controller)
        {
        ...
        static void RemovePreviousController()
        {
            RemovePreviousController(m_ControllerStack.Peek());
        }

        static void RemovePreviousController(Controller controller)
        {
